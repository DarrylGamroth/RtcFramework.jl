...
"""
    InputStreamAdapter(subscription::Aeron.Subscription, agent::AbstractRtcAgent)
...
"""
function InputStreamAdapter(subscription::Aeron.Subscription, agent::AbstractRtcAgent)
